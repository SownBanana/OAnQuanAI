...
send = "D:\\ai\\send.txt"           #đường dẫn đến file send.txt
receive = "D:\\ai\\receive.txt"     #đường dẫn đến file receive.txt
curplayer = 1
game = OanquanGame(8)
net = NNet(game)
net.load_checkpoint('./BackupBest/', 'bestofbest.pth.tar')          #chọn model
